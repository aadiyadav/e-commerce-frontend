...
const Footer: React.FC = () => {
  return (
    <div className="w-full h-full mt-10 md:px-10 md:py-6 p-5 bg-zinc-800 text-gray-200">
      <div className="flex md:justify-center justify-between items-center md:gap-10 text-lg font-medium font-merri">
      ...
      <div className="w-full md:flex justify-between font-mont font-light md:px-10">
        <div className="flex md:mb-0 mb-5 flex-wrap text-xs md:gap-3 gap-2">
          <div className="cursor-pointer md:text-gray-400 text-gray-300 hover:text-gray-200">Privacy Policy</div>
          <div>|</div>
          <div className="cursor-pointer md:text-gray-400 text-gray-300 hover:text-gray-200">User Agreement</div>
          <div>|</div>
          <div className="cursor-pointer md:text-gray-400 text-gray-300 hover:text-gray-200">Terms of Sale</div>
        </div>
        <div className="text-xs flex md:flex-row flex-col items-center md:gap-1">
      ...
      <div className="text-center text-xs font-light pt-4">© January 2025 - Present - Stud.io. All Rights Reserved.</div>
    </div>
  );
};
