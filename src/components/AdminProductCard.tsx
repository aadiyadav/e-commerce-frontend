...
const AdminProductCard: React.FC<AdminProductCardProps> = ({ product, fetchProducts }) => {
  ...
  return (
    <div className="w-40 max-h-64 border border-slate-400 relative shadow-md shadow-zinc-300 p-2 hover:bg-gray-100 transition-all duration-150 cursor-pointer rounded-md">
